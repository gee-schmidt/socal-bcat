...
write.csv(weekly.trap.opp, file = "E:/Socal Bobcat Reproducible Research Folder/Processed Data/socalbcat_weeklytrapopp.csv")

write.csv(break.df, file = "E:/Socal Bobcat Reproducible Research Folder/Processed Data/socalbcat_weeklyoccasions.csv")
